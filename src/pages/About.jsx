      ...
      <section className="about-hero">
        <div className="container split">
          ...
          <img
            ...
            alt="Sol Technology team collaborating around a whiteboard"
          />
        </div>
      </section>
      ...
      <section className="section section-muted">
        <div className="container text-center">
          ...
          <p className="section-subtitle" style={{ maxWidth: 640, margin: '0 auto' }}>
            At Sol Technology, our goal is simple: to demystify technology and make it work
      ...
      <section className="section">
        <div className="container split">
          <img
            ...
            alt="Sol Technology storefront on a Toronto street"
          />
          <div>
            ...
            <p style={{ color: 'var(--color-text-muted)', marginBottom: 16, lineHeight: 1.7 }}>
              Founded in 2015, Sol Technology began with a shared frustration among a group of IT
            ...
            <p style={{ color: 'var(--color-text-muted)', lineHeight: 1.7 }}>
              ...
              expertise with the approachability of a helpful neighbor. We are Sol Technology, and
