    ...
    <footer className="site-footer">
      <div className="container">
        <div className="footer-top">
          <div>
            <div className="footer-brand">Sol Technology</div>
          </div>
        ...
        {showDisclaimer && (
          <div className="footer-notice">
            <strong style={{ color: '#e2e8f0' }}>Important Notice:</strong> SOL Technology operates
        ...
        <div className="footer-bottom">© 2024 Sol Technology. All rights reserved. Professional Canadian Tech Support.</div>
      </div>
    </footer>
  )
}
